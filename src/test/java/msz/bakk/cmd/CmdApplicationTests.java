...
//        WonMessage msg = RDFMessages.createWonMessage(
//                RDFMessages.generateRandomHash());
...
//        //
//
//        Model bobHash = cliBob.send_randomhash();
//        Model aliceHash = cliAlice.send_randomhash();
//
//        WonRepRdfUtils.getRepProperty(bobHash, REP.RANDOM_HASH).matches(testHash);
//        WonRepRdfUtils.getRepProperty(aliceHash, REP.RANDOM_HASH).matches(testHash);
//    }
//
//    @Test
